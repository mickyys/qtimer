...
const WhatsAppButton: React.FC = () => {
    ...
    return (
        <a
            ...
            className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-green-500 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 hover:scale-110 active:scale-95 group"
        ...
        >
            ...
            <span className="absolute right-16 scale-0 group-hover:scale-100 transition-all bg-slate-800 text-white text-xs py-2 px-3 rounded-lg whitespace-nowrap shadow-xl border border-slate-700 pointer-events-none origin-right">
